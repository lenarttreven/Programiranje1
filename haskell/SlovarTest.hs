...
prop_dodajPoisci k v d =
	case poisci k (dodaj k v d) of 
		Just a -> a == v
		Nothing -> False
...
prop_dodajDodajPoisci k v v' d = 
	case poisci k (dodaj k v (dodaj k v' d)) of 
		Just a -> a ==v
		Nothing -> False
...
prod_odstraniPoisci k d = 
	case poisci k (odstrani k d) of 
		Just a -> False
		Nothing -> True
